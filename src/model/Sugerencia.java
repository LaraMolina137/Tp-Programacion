...
public class Sugerencia {
		...
		private static List<Paquete> obtenerPaquetesSobrantes(final List<Paquete> paquetes, final List<Paquete> paquetesPreferidos) {
		...
		private static List<Atraccion> obtenerAtraccionesSobrantes(final List<Atraccion> atracciones, final List<Atraccion> atraccionesPreferidas) {
		...
		private static void sugerirAtracciones(final Usuario usuario, List<Atraccion> atracciones) {
			...
			for(Atraccion atraccion : atracciones) {
				if(atraccion.hayCupos()
						&& !usuario.atraccionEstaEnItinerario(atraccion)
