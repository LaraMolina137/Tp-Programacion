...
public class UsuarioTest {
	...
	public void algunaAtraccionEstaEnItinerarioTest() {
		Usuario usuario = new Usuario(USUARIO.getNombre(), USUARIO.getPreferencia(), USUARIO.getPresupuesto(),
				USUARIO.getTiempoDisponible());

		boolean atraccionEnItinerario = usuario
				.algunaAtraccionEstaEnItinerario(new Paquete(TipoAtraccion.AVENTURA,
						Arrays.asList(new Atraccion("Bosque Negro", 3, 4, 12, TipoAtraccion.AVENTURA),
								new Atraccion("Mordor", 25, 3, 4, TipoAtraccion.AVENTURA)),
						new PromocionPorcentaje(20)));
	...
	public void agregarPaqueteAltinerarioTest() {
		...
		Paquete paquete = new Paquete(TipoAtraccion.AVENTURA,
				Arrays.asList(new Atraccion("Bosque Negro", 3, 4, 12, TipoAtraccion.AVENTURA),
